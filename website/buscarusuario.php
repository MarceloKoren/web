...
<nav class="navbar navbar-light bg-light">
  ...
  <form action="buscarusuario.php" method="get" class="form-inline">
    <input class="form-control mr-sm-2" type="search" name="busqueda" placeholder="Buscar" id="busqueda" aria-label="Buscar" value="<?php echo $busqueda; ?>">
...
<?php
             conectar();
             $consulta = "SELECT COUNT(*) as totalregistros FROM `personas` WHERE ( 
             ...
             {   
              ...
              $consulta = "SELECT * FROM personas WHERE ( 
                usuario LIKE '%$busqueda%' OR
                apellido LIKE '%$busqueda%' OR 
                nombre LIKE '%$busqueda%' OR
                email LIKE '%$busqueda%' ) 
                 ORDER BY apellido ASC LIMIT $desde,$porpagina"; 
