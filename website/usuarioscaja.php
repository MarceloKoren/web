...
<nav class="navbar navbar-light bg-light">
   <form action="importarcli.php" method="post" enctype="multipart/form-data" id="import_form" class="form-inline mt-2 mt-md-0">
      <div>
...
<?php
             conectar();
             $consulta = "SELECT COUNT(*) as totalregistros FROM `usuarioscaja` "; 
             ...
             {   
              ...
              $consulta = "SELECT apellido,nombre,usuariocaja,passcaja,estado FROM personas INNER JOIN usuarioscaja WHERE personas.usuario=usuarioscaja.usuario"; 
