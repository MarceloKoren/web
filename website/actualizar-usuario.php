...
*/ 
   $query = "UPDATE personas SET  apellido = '$form_apellido', 
                                  nombre ='$form_nombre', 
                                  sexo = '$form_sexo',
                                  fechanacimiento = '$form_fecha', 
                                  estadocivil ='$form_estado',
                                  direccion = '$form_direccion', 
                                  localidad = '$form_localidad', 
                                  provincia = '$form_provincia', 
                                  codigopostal = '$form_codigopostal', 
                                  nacionalidad = '$form_nacionalidad',
                                  telefono = '$form_telefono',
                                  email = '$form_email',
                                  fallecido = '$form_fallecido'
                                  WHERE  usuario = $form_dni";
  $conexion->query($query);

   $query2 = "UPDATE clientes SET  fuerza = '$form_fuerza', 
                                   jerarquia = '$form_jerarquia', 
                                   estado = '$form_estadofuerza'  
                                   WHERE  usuario = $form_dni ";
...
<html lang="es">
  <head>
    ...
    <title>Estudio Koren - Actualizacion usuario</title>
  ...
  <?php include 'admin/menulateral.html'; ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Actualizacion Registro exitoso</h1></br>
