...
<br>
<h1 class="h2">Plataforma Mi Pago - En Proceso</h1>
...
<?php
             conectar();
             $consulta = "SELECT COUNT(*) as totalregistros FROM  libro1 where (state ='Pago en proceso')"; 
             ...
             {   
              ...
              $consulta = "SELECT * FROM  libro1 where state ='Pago en proceso' ORDER BY paymentDate ASC LIMIT $desde,$porpagina"; 
